...
public:
    ...
    static JSON Load( const string &, std::function<void(const std::string &err)> );
...
namespace {
JSON parse_next( const string &, size_t &, std::function<void(const std::string &err)> );

void consume_ws( const string &str, size_t &offset ) {
    while( isspace( str[offset] ) ) ++offset;
}

JSON parse_object( const string &str, size_t &offset, std::function<void(const std::string &err)> on_error ) {
...
JSON parse_array( const string &str, size_t &offset, std::function<void(const std::string &err)> on_error ) {
...
JSON parse_string( const string &str, size_t &offset, std::function<void(const std::string &err)> on_error ) {
    JSON String;
    string val;
...
JSON parse_number( const string &str, size_t &offset, std::function<void(const std::string &err)> on_error ) {
    JSON Number;
    string val, exp_str;
    char c;
    bool isDouble = false;
...
JSON parse_bool( const string &str, size_t &offset, std::function<void(const std::string &err)> on_error ) {
    JSON Bool;
...
JSON parse_null( const string &str, size_t &offset, std::function<void(const std::string &err)> on_error ) {
    JSON Null;
...
JSON parse_next( const string &str, size_t &offset, std::function<void(const std::string &err)> on_error ) {
    char value;
    consume_ws( str, offset );
    value = str[offset];
    switch( value ) {
