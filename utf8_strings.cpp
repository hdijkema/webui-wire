...
static size_t StrLenUtf32AsUtf8(const Utf32Char* pUtf32);
static Utf8Char* Utf32ToUtf8(const Utf32Char* pUtf32);
static Utf32Char* Utf8ToUtf32(const Utf8Char* pUtf8);
...
*******************************************************************************************/
static Utf32Char* StrToUprUtf32(Utf32Char* pUtf32)
{
	Utf32Char* p = pUtf32;
	if (pUtf32 && *pUtf32) {
		while(*p) {
...
static Utf32Char* StrToLwrUtf32(Utf32Char* pUtf32)
{
	Utf32Char* p = pUtf32;
	if (pUtf32 && *pUtf32) {
		while(*p) {
...
static size_t StrLenUtf32(const Utf32Char* str)
{
    Utf32Char* s;
...
static int StrnCmpUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2, size_t ztCount)
{
...
static int StrnCiCmpUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2, size_t ztCount)
{
...
static int StrCiCmpUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2)
{
...
static Utf32Char* StrCiStrUtf32(const Utf32Char* Utf32s1, const Utf32Char* Utf32s2)
{
